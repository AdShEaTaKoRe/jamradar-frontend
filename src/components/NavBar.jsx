    ...
    render () {
        return (
         <div class="ui top fixed menu" >
            ...
            <Link className="item" to="/edit"><i aria-hidden="true" className="edit icon" style={{color: "teal"}}></i>Edit Profile</Link>
            ...
            {(this.props.email) ? (<Link className="item" to="/" onClick={this.props.signOut}><i aria-hidden="true" className="minus icon" style={{color: "red"}}></i>Sign-Out</Link>) : ""}
            </div>
        </div>
        )
    }
